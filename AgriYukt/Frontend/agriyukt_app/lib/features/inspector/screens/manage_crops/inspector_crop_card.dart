...
class InspectorCropCard extends StatelessWidget {
  ...
  final VoidCallback onDeleteTap; // <--- REQUIRED for delete to work
  ...
  const InspectorCropCard({
    ...
    required this.onDeleteTap, // <--- REQUIRED
  }) : super(key: key);
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: onDeleteTap, // <--- CONNECTED HERE
                  child: Container(
                    width: 36,
                    height: 36,
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        isActive ? Colors.green.withOpacity(0.9) : Colors.grey,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: const Text(
                          "Edit",
                          style: TextStyle(color: Color(0xFF387C2B)),
                        ),
